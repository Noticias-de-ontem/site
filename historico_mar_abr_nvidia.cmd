@echo off
cd /d "%~dp0"
title Noticias de Ontem - Mar-Abr (NVIDIA)
...
echo.
echo ========================================================
echo   Processamento Paralelo - Março e Abril (NVIDIA)
echo ========================================================
echo.
python run_historical_scrapers.py --lang pt --start-year 1990 --end-year 2026 --limit 0 --months 3,4 --use-nvidia --nvidia-model meta/llama-3.1-8b-instruct
...
if %EXIT_CODE% equ 2 (
  ...
  echo.
  echo [SUCESSO] Processamento de Março e Abril concluido!
