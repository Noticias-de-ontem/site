@echo off
cd /d "%~dp0"
title Noticias de Ontem - Jan-Fev (NVIDIA)
...
echo.
echo ========================================================
echo   Processamento Paralelo - Janeiro e Fevereiro (NVIDIA)
echo ========================================================
echo.
python run_historical_scrapers.py --lang pt --start-year 1990 --end-year 2026 --limit 0 --months 1,2 --use-nvidia --nvidia-model meta/llama-3.1-8b-instruct
...
if %EXIT_CODE% equ 2 (
  ...
  echo.
  echo [SUCESSO] Processamento de Janeiro e Fevereiro concluido!
